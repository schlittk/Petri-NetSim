...
/**
 * Eine PetriNetSimStell repräsentiert ein Stelle in einem Petrinetz. Eine Stelle hat einen Namen
 * und eine aktuelle, eine minimale und eine maximale Markenanzahl. ??and keeps track of its superclasses, associations
 * and dependencies.?? mal sehen ob das nötig ist
 */
public class PetriNetSimStelle implements Serializable {
    ...
    /**
     * Festlegen des Namens der Stelle. Der Name der Stelle kann geändert werden
    ...
    /**
     * Gibt den namen der Stelle zurück
     *
    ...
    /**
     * Gibt die Aktuelle Anzahl Marken zurück
     * 
	...
	/**
     * Gibt die maximale Anzahl Marken zurück
     * 
	...
	/**
	 * Legt fest wie viele Marken maximal auf der Stelle liegen dürfen
	 * 
	...
	/**
     * Gibt die minimale Anzahl Marken zurück
     * 
	...
	/**
	 * Legt fest wie viele Marken minimal auf der Stelle liegen müssen
	 * 
